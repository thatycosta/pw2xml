 ...
 * generated in the edu.ifrs.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _SumResponse_QNAME = new QName("http://ws.ifrs.edu/", "sumResponse");
    private final static QName _Sum_QNAME = new QName("http://ws.ifrs.edu/", "sum");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.ifrs.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ifrs.edu/", name = "sumResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ifrs.edu/", name = "sum")
